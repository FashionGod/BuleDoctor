      ...
      wx.cloud.callFunction({
        ...
        if (res.result.data == null) {
          ...
          this.setData({
            ...
            department: res.result.data.department,
            price: res.result.data.price,
            checkbox: res.result.data.worktime,
            experience: res.result.data.experience
          })
        }
        console.log(this.data)
      })
