...
Page({
  ...
  gotoDetail: function (e) {
    ...
    wx.navigateTo({
      url: '../physicalExaminationRecordDetail/physicalExaminationRecordDetail?department=' + this.data.departmentList[e.currentTarget.dataset.index]  + '&time=' + this.data.cardList[e.currentTarget.dataset.index].date + ' ' + this.data.cardList[e.currentTarget.dataset.index].payTime + '&index=' + this.data.cardList[e.currentTarget.dataset.index].orderNumber,
