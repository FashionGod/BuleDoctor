...
Page({
  ...
  */
  onLoad: function (options) {
    ...
    let promise = new Promise(function (resolve, reject) {
      ...
      wx.cloud.callFunction({
        ...
        success(res) {
          if (res.result.data == -1) {
            ...
            wx.setStorageSync("resOrder2", res.result.orderdata.data);
          }
        },
        fail(err) {
          wx.showModal({
      ...
      this.data.order = wx.getStorageSync("resOrder2");
  ...
  */
  ...
  toItemAppointTime(e) {
    ...
    wx.navigateTo({
      url: 'appointmentTime/appointmentTime?num=' + this.data.num +
        '&weekDate=' + weekDate +
